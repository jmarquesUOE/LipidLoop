...
def draw(ax):
    ...
    ax.text(PRECURSOR - 8, 0, "precursor\nm/z 876.80,\nshared", ha="right", va="center", fontsize=5.5)
    ax.text(0.98, 0.97, "target: TG 16:0_18:1_18:1 [M+NH4]+", transform=ax.transAxes, ha="right", va="top", fontsize=6, color=style.COLOUR["edge"])
    ax.text(0.98, 0.03, "decoy: same class and precursor,\nchains shifted by whole CH2", transform=ax.transAxes, ha="right", va="bottom", fontsize=6, color=style.COLOUR["edge"])
    ax.set_xlim(200, 900)
