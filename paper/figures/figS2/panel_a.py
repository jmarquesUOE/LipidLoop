"""Figure S2 (was Figure 2C): LipiDex dot product against the reimplementation's, every Set 2 spectrum matched
...
def load():
    rows = list(csv.DictReader((HERE / "set2_dot_pairs.csv").open()))
    for r in rows:
